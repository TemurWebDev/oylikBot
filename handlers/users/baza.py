...
def userget():
    ...
    url = 'https://albino.pythonanywhere.com/api/usertg/'
...
def user(user_id):
    ...
    url = 'https://albino.pythonanywhere.com/api/user/'+ user_id + '/'
    respons = requests.get(url)
    return respons.json()
...
def oylik(user_id,oy):
    #url = 'https://temur01.pythonanywhere.com/api/user/'+ user_id + '/'
    url = 'https://albino.pythonanywhere.com/api/oylik/'+ user_id + '/' + oy + '/'
    respons = requests.get(url)
    return respons.json()


def sana():
    url = 'https://albino.pythonanywhere.com/api/sana/'
    respons = requests.get(url)
    data = respons.json()
